      ...
      <div>
        ...
        <div style={{ marginLeft: '6px', marginRight: '6px' }}>
          <div 
            ...
            <p>
              Guy Lepage, is the founder of <a href="http://universe.engineering" alt="Universe Labs" target="_blank" rel="noopener noreferrer" className="bg-black text-light mx-1">&nbsp;Universe Labs&nbsp;</a>, a blockchain agnostic, decentralized web accessibility node network, founder of <a href="http://papriika.com" alt="Papriika Hotel Club" target="_blank" rel="noopener noreferrer" className="bg-black text-light mx-1">&nbsp;Papriika.com&nbsp;</a>, an open source decentralized hotel booking app, and sits on the Board of Advisors to <a href="https://news.net-cents.com/2018/03/21/blockstacks-guy-lepage-joins-netcents-technologys-board-advisors/" alt="NetCents Technology" target="_blank" rel="noopener noreferrer" className="bg-black text-light mx-1">&nbsp;NetCents Technology&nbsp;</a>, a publicly traded tech company trading in <a href="https://www.bloomberg.com/quote/NC:CN" alt="NC:Canadian Sec Stock Quote - NetCents Technology Inc - Bloomberg Markets" target="_blank" rel="noopener noreferrer" className="bg-black text-light mx-1">&nbsp;Canada&nbsp;</a> and <a href="https://www.bloomberg.com/quote/26N:GR" alt="26N:Frankfurt Stock Quote - NetCents Technology Inc - Bloomberg Markets" target="_blank" rel="noopener noreferrer" className="bg-black text-light mx-1">&nbsp;Germany&nbsp;</a>. Guy is an open source product UX/UI designer and front-end developer with 19 years of industry experience.
            </p>
